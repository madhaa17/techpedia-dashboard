...
-- CreateIndex
CREATE INDEX "InvalidToken_token_idx" ON "InvalidToken"("token");
...
-- AddForeignKey
ALTER TABLE "SalesReport" ADD CONSTRAINT "SalesReport_orderId_fkey" FOREIGN KEY ("orderId") REFERENCES "Order"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
